...
public class DisplayHomeArea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_home_area);
        ...
        barChart.setDescription("activities home area");

    }

    public float getCountWalking(){
        return db.countActivityWalkingHomeArea();
    }

    public float getCountRunning(){
        return db.countActivityRunningHomeArea();
    }

    public float getCountStill(){
        return db.countActivityStillHomeArea();
    }
