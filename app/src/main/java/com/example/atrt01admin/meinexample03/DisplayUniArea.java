...
public class DisplayUniArea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_uni_area);
    ...
    public float getCountWalking(){
        return db.countActivityWalkingUniArea();
    }

    public float getCountRunning(){
        return db.countActivityRunningUniArea();
    }

    public float getCountStill(){
        return db.countActivityStillUniArea();
    }
